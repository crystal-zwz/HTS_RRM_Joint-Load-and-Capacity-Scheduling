...
K=64;% Number beams. IT MUST BE EVEN)
    ...
    for ind_scen=1:Nscen  % Select Scenario
      ...
      sprintf('Start of Batch simulations %i of Scenario %i',ind_batch,ind_scen) % Display to keep track of the simulations     
        ...
        for indsims=1:Nsims % Monte-Carlo simulations for the selected scenario and batch size.
            ...
            load("ChuanZang_Nuserbeam0419.mat")
            % Nuser_beam = Nuser_beam';
            ...
            Sim_object= ResourceAssignmentTwoDimesion_r7_China(scen_data);
            ...
            res_NQU=[   NQU_POW NQU_BW NQU_CR NQU_MAP NQU_BW_CR  NQU_BW_MAP NQU_BW_POW]';
            res_NU=[   NU_POW NU_BW NU_CR NU_MAP NU_BW_CR  NU_BW_MAP NU_BW_POW]';
            res_OffRate=[   Offer_rate_POW Offer_rate_BW Offer_rate_CR Offer_rate_MAP Offer_rate_BW_CR  Offer_rate_BW_MAP Offer_rate_BW_POW]';
            res_MinUserRate=[    Min_User_rate_POW  Min_User_rate_BW  Min_User_rate_CR Min_User_rate_MAP Min_User_rate_BW_CR  Min_User_rate_BW_MAP  Min_User_rate_BW_POW]';
            
            T = table(res_NQU,res_NU,res_OffRate,res_MinUserRate,'VariableNames', ...
                {'NQU','NU','Offered Rate [Mps]','Min. User Rate [Mbps]'}, ...
                'RowName',{'POW','BW','CR','MAP','CR-BW','BW-MAP','BW-POW'});
            disp(T)
        ...
        save([ parentpath  '\' label_alpha{ind_scen} '\'  text_file  '_Batch_' num2str(ind_batch) '_alpha_' label_alpha{ind_scen} '.mat'],...
            ...
            'R_off_BW_CR_c','R_off_BW_MAP_c','Bandwidth_Allo_BW','Bandwidth_Allo_BW_CR','Bandwidth_Allo_BW_MAP','Power_Allo_POW','Power_Allo_BW_POW',...
            'Bandwidth_Allo_BW_POW','user_beams_c','users_locations_c','Assig_BW_CR_c','Assig_MAP_c','Assig_CR_c','Assig_BW_MAP_c','R_off_BW_POW_c','IterNum_Av')
